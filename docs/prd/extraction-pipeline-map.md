...
│                                                          │
│  ✅ 裁判自己校準過：12 課已知答案 → 12/12 一致            │
│     （第一版只有 7/12，露餡後修了三個真問題）              │
│  ✅ 負向對照：漏抽 2 題 → 指名「漏了第 4、5 題」exit 1     │
│                題數對但編號錯位 → 也擋下來                 │
│                                                          │
...
| **⑥b 見證對帳** | 🔧 | **穩** | 校準 12/12 · **30 課實跑：plan 28/30、verify 28/28** · mutation 27/28 抓到 | ✅ 飛機鐵律 2b 已接 |
