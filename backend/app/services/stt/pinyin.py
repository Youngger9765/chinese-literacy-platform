"""
Pinyin lookup map and homophone helpers.

Ported from frontend/src/utils/pinyin.ts PINYIN_GROUPS.
The core data and get_pinyin/is_homophone functions are used by both the
algorithm layer and the reading_evaluation_service fallback.
"""

# ---------------------------------------------------------------------------
# Pinyin lookup map (toneless): pinyin → characters
# ---------------------------------------------------------------------------
