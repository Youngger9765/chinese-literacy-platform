...
BASELINE = {
    ...
    # 2026-08-31（#3011）：standard 128 → 132。
    # 體育生品格教育 L12–L15（L0176–L0179）四課進來。它們是 2026-08-17 之後才加進
    # 來源 Drive 的，抽取管線先前沒跟上，所以線上一直沒有這四課。
    # 四課的 profile 都是 standard：單一 ☞ 錨點、課文在表格裡、右緣有累計字數欄、
    # 段落 idx 唯一 —— 跟既有 11 課體育生教材同一個形狀，沒有新的來源型態。
    "standard": 132,
    "no_section": 19,
    "multi_anchor": 7,
    "no_anchor": 7,
