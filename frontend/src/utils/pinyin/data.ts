 ...
 *
 * Contains:
 *   - PINYIN_GROUPS: compact encoding of pinyin → characters
 *   - charToPinyin: inverted map built at load time (character → pinyin)
 *   - NEAR_SOUND_PAIRS: initials commonly confused in STT
 *   - STT_EQUIVALENT_GROUPS: character sets treated as interchangeable by STT
 */

// Compact encoding: pinyin → characters that share that reading.
// We invert this at load time into a char → pinyin map.
export const PINYIN_GROUPS: Record<string, string> = {
  a: '啊阿嗄',
  ai: '愛哀矮挨礙癌唉藹艾埃隘欸捱靄',
  an: '安暗按岸案俺鞍氨黯庵鵪諳',
  ang: '昂盎骯',
...
export const charToPinyin = new Map<string, string>();
 ...
 */
export const NEAR_SOUND_PAIRS: [string, string][] = [
  ['zh', 'z'], ['sh', 's'], ['ch', 'c'],
  ['n', 'l'], ['r', 'l'],
 ...
 */
export const STT_EQUIVALENT_GROUPS: Set<string>[] = [
  new Set(['的', '得', '地']),
];
