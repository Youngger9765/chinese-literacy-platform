/**
 * useKeyPassageReadingTtsQueue — TTS paragraph-queue management for KeyPassageReading.
 *
 * Issue #1880: Extracted from KeyPassageReading.tsx to isolate TTS queueing logic.
 *
...
interface UseKeyPassageReadingTtsQueueProps {
  storyContent: string[];
}

interface UseKeyPassageReadingTtsQueueReturn {
...
export function useKeyPassageReadingTtsQueue({
  storyContent,
}: UseKeyPassageReadingTtsQueueProps): UseKeyPassageReadingTtsQueueReturn {
