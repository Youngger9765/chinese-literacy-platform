...
const ParagraphCard: React.FC<ParagraphCardProps> = ({
  ...
  // isTtsLoading comes from useTtsPlayback hook (via ParagraphReading) — no local state needed.
  ...
  return (
    ...
    >
      ...
      {/* Recording indicator + CTA live in ParagraphReadingControls (fixed bottom bar) */}
