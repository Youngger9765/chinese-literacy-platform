...
interface ParagraphReadingControlsProps {
  ...
  volumeLevel?: number;
  /**
   * Painpoint 2: current mic error string (from ParagraphReading.micError state).
   ...
   * Passed from ParagraphReading via paragraphRecorder.audioUrl during recordingPendingReview.
   */
...
/**
 * ParagraphReadingControls — fixed bottom CTA bar for ParagraphReading.
 ...
 */
const ParagraphReadingControls: React.FC<ParagraphReadingControlsProps> = ({
  isSessionActive,
  isPreparing,
  isTtsLoading,
  isTtsSpeaking,
...
export default ParagraphReadingControls;
