...
interface LiveTutorFeedbackDrawerProps {
  show: boolean;
  onClose: () => void;
...
/**
 * LiveTutorFeedbackDrawer — slide-up drawer showing TutorFeedbackPanel.
 * Handles backdrop + close button.
 */
const LiveTutorFeedbackDrawer: React.FC<LiveTutorFeedbackDrawerProps> = ({
  show,
  onClose,
  scrollRef,
  isSessionActive,
...
export default LiveTutorFeedbackDrawer;
