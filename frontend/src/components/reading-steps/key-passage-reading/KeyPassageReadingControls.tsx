/**
 * KeyPassageReadingControls — Fixed bottom CTA buttons for KeyPassageReading (Issue #1960).
 *
 * Extracted from KeyPassageReading.tsx to own the state-machine button rendering:
 *   idle       → AI 朗讀 + 開始朗讀
...
export interface KeyPassageReadingControlsProps {
  state: ControlState;
...
const KeyPassageReadingControls: React.FC<KeyPassageReadingControlsProps> = ({
  state,
  onSpeak,
  onStartSession,
  onSubmit,
...
export default KeyPassageReadingControls;
