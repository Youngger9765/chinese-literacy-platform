/**
 * FluencyProgressChart — 4-attempt progress line chart for KeyPassageReading.
 *
...
export interface KeyPassageReadingAttempt {
...
interface FluencyProgressChartProps {
  attempts: KeyPassageReadingAttempt[];
...
function getTrendArrow(attempts: KeyPassageReadingAttempt[], useSec: boolean): 'up' | 'down' | 'flat' | null {
...
function buildChartData(attempts: KeyPassageReadingAttempt[], useSec: boolean) {
